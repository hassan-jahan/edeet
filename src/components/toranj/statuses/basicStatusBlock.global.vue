    ...
    return {
      settingsForm: {
        ...
        children: [
          ...
          {
            slug: 'settings.assignMode',
            label: 'Assign Mode',
            component: 'select',
            size: 'sm',
            default: '',
            values: [{ text: 'All', value: '' }, { text: 'None', value: 'none' }, {
              text: 'Random',
              value: 'random',
            }],
            description: 'How to create task for assignees?',
            showIf: 'assignees || assignees.length',
          },

          {
            slug: 'settings.netDate',
            label: 'Deadline',
            component: 'input-text',
            type: 'number',
            append: ' Days',
            description: 'How much time assignees have to finish the task?',
            showIf: 'assignees || assignees.length',
          },
          {
          ...
          //     // 'required': true,
          //     'description': 'Notify a user when the status change to this one',
          // },
