...
export default {
  ...
  mounted() {
    ...
    this.editor.onload = (core, onload) => {
      ...
      const sunEditorEl = this.$parent.$el.getElementsByClassName('sun-editor')[0]
      sunEditorEl.classList.add('sepid-editor')
      sunEditorEl.classList.remove('sun-editor')

      // this.$parent.$el.getElementsByClassName('sun-editor')[0].className="sepid-editor"
      const sunEditorCommonEl = this.$parent.$el.getElementsByClassName('sun-editor-common')[0]
...
<style>
.sun-editor {
/*//wait until rebranding*/
    display: none !important;
}

.sepid-editor-common, .sun-editor-common {
...
.sepid-editor, .sepid-editor button span {
    width: auto;
    height: auto;
...
.sepid-editor .se-dialog-content {
    color: #666;
}

.sepid-editor .se-wrapper .se-wrapper-wysiwyg {
    background: inherit;
}

.sepid-editor .se-wrapper .se-wrapper-inner {
    min-height: initial;
}

.sepid-editor .link-content span {
    display: none;
}
...
.sepid-editor .se-line-breaker {
    z-index: 2000;
}

.sepid-editor .se-controller {
    z-index: 600;
    border: none;
}
...
.sepid-editor .se-wrapper-code {
    width: 100%;
}

.sepid-editor .se-toolbar.se-toolbar-balloon {
    min-width: 425px;
}

.sepid-editor .se-dialog .se-dialog-inner .se-dialog-content {
    min-width: 420px;
}

.sepid-editor .se-wrapper .se-placeholder {
