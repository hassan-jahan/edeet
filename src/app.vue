...
Vue.prototype.$axios = { get: (arg1 = '', arg2 = '') => {}, post: (arg1 = '', arg2 = '') => {} }
Vue.prototype.axios = {}
Vue.prototype.axios.defaults = { get: (arg1 = '', arg2 = '') => {}, post: (arg1 = '', arg2 = '') => {} }
Vue.prototype.$route = { params: { id: '123' }, query: { id: '123' } }
Vue.prototype.$auth = { settings: {}, isStaff: () => {}, token: '123' } // uploader sun-editor
// isStaff
